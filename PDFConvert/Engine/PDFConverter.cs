...
namespace PDFConvert.Engine
{
    ...
    public static class PDFConverter
    {
                    ...
                    for (int i = 0; i < pageCount; i++)
                    {
                        ...
                        try
                        {
                            ...
                            Pdfium.FPDF_RenderPageBitmap(
                                ...
                                height: heightPx,
                                rotate: 0,
                                flags: Pdfium.FPDF_LCD_TEXT | Pdfium.FPDF_ANNOT |
                                       (grayscale ? Pdfium.FPDF_GRAYSCALE : 0));

                            IntPtr buf = Pdfium.FPDFBitmap_GetBuffer(bmp);
                            byte[] imgBytes = EncodeImageFromPointer(buf, widthPx, heightPx, stride, quality,
                                imageFormat,
                                grayscale);
        ...
        /// </param>
        public  class ImageResult(byte[] Bytes, string Mime, string SuggestedFileName);
